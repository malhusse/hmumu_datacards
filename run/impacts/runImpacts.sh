...
combineTool.py -M Impacts -d ../datacard_all_cats.root --doInitialFit -m 125 -t -1 --toysFrequentist --expectSignal 1 -n postfit_asimov ${OPTIONS}

combineTool.py -M Impacts -d ../datacard_all_cats.root --doFits -m 125 -t -1 --toysFrequentist --expectSignal 1 ${OPTIONS} -n postfit_asimov --job-mode condor --task-name Impacts_doFits --sub-opts="$JOBOPTS\n+JobBatchName=\"Impacts\""
